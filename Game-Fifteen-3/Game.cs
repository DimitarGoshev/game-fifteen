        ...
        static void Main(string[] argumentite)
        {
            ...
            while (!proverka(matrica))
            {
                ...
                if (вход == "top")
                {
                    for (int i = 0; i < 5; i++)
                    {
                        Console.WriteLine("Name : {0} , moves : {1} ", TopScores.igrachi[i], 
                            TopScores.hodove[i]);
                    }
                ...
                for (int i = 0; i < 4; i++)
                {
                    if (i == 0)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                ChangeAndDraw(matrica, rowCurrentElement - 1, 
                                    columnCurrentElement, rowCurrentElement, columnCurrentElement, вход);
                    ...
                    if (i == 2)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                ChangeAndDraw(matrica, rowCurrentElement, 
                                    columnCurrentElement - 1, rowCurrentElement, 
                                    columnCurrentElement, вход);
                    ...
                    if (i == 3)
                    {
                        ...
                        else
                        {
                            if (matrica[rowCurrentElement, columnCurrentElement + 1] == " ")
                            {
                                ChangeAndDraw(matrica, rowCurrentElement, columnCurrentElement + 1, 
                                    rowCurrentElement, columnCurrentElement, вход);
